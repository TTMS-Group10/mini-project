        ...
        <div class="container">
            ...
            <div class="head">
                ...
                <div class="search" id="search">
                    <div>
                        <form action="manage_user.php" method="post" class="search-box-wrapper">
            ...
            if(isset($_POST['search']))
            {
                ...
                $results=mysqli_query($connection,"SELECT * FROM user_details WHERE account_type='User' AND (name LIKE '%$searchq%' OR email LIKE '%$searchq%')");
            ...
            {
                $results=mysqli_query($connection,"SELECT * FROM user_details WHERE account_type='User' ORDER BY user_id");
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="del">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#DelUser<?php echo $row['user_id'];?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger" href="../php/admin_um.php?del_u=<?php echo $row['user_id'];?>">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
